...
/// Unified similar media item (replaces SimilarMovie and SimilarShow)
struct SimilarMedia: Identifiable, Codable {
    let id: Int
...
/// Response wrapper for similar media
struct SimilarMediaResponse: Codable {
    let results: [SimilarMedia]
}
